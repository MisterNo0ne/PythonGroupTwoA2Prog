...
def setup():
    ...
    signs.append(Sign(2750, 800, "Rock can shatter things if\nthey're brittle...", signimg, 15, 2))
    signs.append(Sign(1400, 800, "Ice can freeze a\nwet enemy...", signimg, 15, 2))
    signs.append(Sign(2550, 1850, "Did you get enough\nhealth potions?", signimg, 15, 2))
    signs.append(Sign(800, 1350, "Water is a very\ngood conductor...", signimg, 15, 2))
    signs.append(Sign(1500, 1500, "Tangled grass enemies get\nhealed, but the vines can also\n make flames much stronger...", signimg, 12, 3))
